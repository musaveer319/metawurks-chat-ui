  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-4 relative overflow-hidden" style={{ background: '#09090b' }}>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[50vw] h-[50vw] rounded-full blur-[120px] opacity-20 animate-pulse" style={{ background: 'linear-gradient(to right, #7c6bff, #4f46e5)' }} />
        <div className="absolute top-[60%] -right-[10%] w-[40vw] h-[40vw] rounded-full blur-[100px] opacity-15" style={{ background: 'linear-gradient(to right, #ec4899, #8b5cf6)' }} />
      </div>
      ...
      <div className="w-full max-w-md p-8 md:p-10 rounded-3xl shadow-2xl z-10 relative overflow-hidden" style={{ 
        ...
        <div className="absolute top-0 left-0 w-full h-[1px]" style={{ background: 'linear-gradient(90deg, transparent, rgba(124, 107, 255, 0.8), transparent)' }} />
        
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-6 shadow-lg" style={{ background: 'linear-gradient(135deg, rgba(124, 107, 255, 0.2), rgba(91, 140, 238, 0.2))', border: '1px solid rgba(124, 107, 255, 0.3)' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7c6bff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
            </svg>
          </div>
          <h1 className="text-3xl font-extrabold tracking-tight mb-2 text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(to right, #fff, #a1a1aa)' }}>Welcome back</h1>
          <p className="text-sm font-medium" style={{ color: '#a1a1aa' }}>Sign in to continue to Chat Ai</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 mb-8">
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input 
                ...
                onFocus={(e) => {
                  e.target.style.borderColor = '#7c6bff';
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full mt-2 py-3 rounded-xl font-bold transition-all duration-300 flex justify-center items-center gap-2 hover:scale-[1.02] active:scale-95 shadow-lg relative overflow-hidden group"
            style={{ background: 'linear-gradient(135deg, #7c6bff, #4f46e5)', color: 'white', opacity: loading ? 0.7 : 1 }}
          >
        ...
        <p className="text-center text-sm mt-10 font-medium" style={{ color: '#a1a1aa' }}>
          Don&apos;t have an account? <Link href="/signup" className="text-white hover:text-[#7c6bff] transition-colors duration-200">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
